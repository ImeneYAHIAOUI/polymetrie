...
postgres_db_connections = Gauge('postgres_db_connections', 'Number of connections to PostgreSQL database')
redis_db_connections = Gauge('redis_db_connections', 'Number of connections to Redis database')
