...
visit_counter = Counter('visit_counter', 'Total number of visits for each page', ['page_url'])
visit_rate = Gauge('visit_rate', 'Visit rate per second for each page', ['page_url'])
